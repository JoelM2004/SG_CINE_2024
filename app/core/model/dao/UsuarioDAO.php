...
use app\core\model\validation\UsuarioValidation;
...
final class UsuarioDAO extends DAO implements InterfaceDAO
{
    ...
    public function save(InterfaceDTO $object): void
    {
        ...
        $validation= new UsuarioValidation($this->conn);

        $validation->validate($object);
        $clave = password_hash($object->getClave(), PASSWORD_DEFAULT);
        $validation->validateCuenta($object);
        $validation->validateCorreo($object);
        $validation->existePerfil($object->getPerfilId());
    ...
    public function forgetPassword(array $object): void
    {
        ...
        $validation= new UsuarioValidation($this->conn);
        $validation->validateCorreoExiste($object);
