...
<div class="container-fluid my-4">
    <div class="row g-3">
        <!-- Formulario de Edición de Función -->
        <form id="formFuncionM" class="col-lg-4 col-md-6 col-sm-12 p-4 bg-light border rounded shadow-sm" autocomplete="off">
            <h4 class="text-center text-secondary">Edición de Función</h4>
