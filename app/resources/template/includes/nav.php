<nav class="navbar navbar-dark bg-dark fixed-top">
  <div class="container-fluid">
    ...
    <h2 class="text-white">Los Pollos Hermanos</h2>
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        ...
        <div class="mt-3">
          <button class="btn btn-success" onclick="window.location.href='<?= APP_FRONT . 'autentication/index' ?>'">
            Iniciar Sesión o Registrarse
          </button>

          <button class="btn btn-danger mt-2" onclick="window.location.href='<?= APP_FRONT . 'autenticacion/logout' ?>'">
            Cerrar Sesión
          </button>
        </div>
      </div>
