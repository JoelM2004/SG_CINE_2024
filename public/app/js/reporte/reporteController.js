...
print: () => {
    ...
    const tipoReporteText = tipoReporteSelect.options[tipoReporteSelect.selectedIndex].text;
    ...
    if (tipoReporteValue === 'funciones') {
        ...
        const funcionText = funcionSelect.options[funcionSelect.selectedIndex].text;
        ...
        const peliculaText = peliculaSelect.options[peliculaSelect.selectedIndex].text;
        ...
        const programacionText = programacionSelect.options[programacionSelect.selectedIndex].text;
        const programacionInfo = document.createElement('p');
        programacionInfo.innerText = 'Programación Seleccionada: ' + programacionText;
    ...
    cantidadEntradasP.innerText = 'Cantidad de Entradas Vendidas: ' + cantidadEntradas;
    ...
    precioPromedioP.innerText = 'Precio Promedio de Entradas: ' + precioPromedio;
    ...
    const tipoReporteLabel = clonedElement.querySelector('label[for="tipoReporte"]');
    if (tipoReporteLabel) tipoReporteLabel.remove();

    // Eliminar las secciones de datos (funciones, películas, programaciones, usuario)
    const sectionsToRemove = ['funcionSection', 'peliculaSection', 'programacionSection', 'usuarioSection'];
    ...
    divsToRemove.forEach(div => {
        ...
        if (label && input) {
            ...
            if (label.innerText.includes('Cantidad de Entradas Vendidas:') ||
